    ...
    <div class="row">
        <div class="col-rg-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="name" name="name" value="<?= $admin['nama']; ?>" readonly>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="jabatan" name="jabatan" value="Administrator" readonly>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-3">
                            <img src="<?= base_url('assets/img/profile/') . $admin['gambar']; ?>" class="img-thumbnail">
                        </div>
                        <div class="col-sm-9">
